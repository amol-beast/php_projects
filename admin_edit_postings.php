...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['edit_postings']))
{
	...
	$added_by="amol";
    $date_added="2013-02-03"; 
	//commands
	$statement1="update $dbname.$admin_job_postings set heading='$heading',description='$description', location='$location',last_date='$last_date',industry='$industry',date_added='$date_added',added_by='$added_by' where id='$id'";
	if($debug==1)
		echo $statement1;	
...
<div id="section1" class="section">
  ...
  <div style="MIN-HEIGHT: 0px" id="fb-submit-button-div" class="fb-footer fb-item-alignment-center">
    ...
    <?php  
		...
		echo "<tr><td>".$id ."</td><td>".$heading."</td><td>".$location."</td><td>".$description."</td><td>".$industry."</td><td>".$last_date."</td><td>".$date_added."</td><td>"	.$added_by."</td><td><a href='admin_edit_postings.php?id=".$id."'>Edit</a>/<a href='admin_delete_postings.php?id=".$id."&confirm=1'>Delete</a></td> </tr>";
		}
		echo "</tbody></table>";
	}
	?>
